// ======================================================================
// \title  QueuePrioritiesTopologyAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for QueuePriorities topology
// ======================================================================

#include "QueuePrioritiesTopologyAc.hpp"
...
namespace M {
  ...
  void configureQueues() {
    static const Os::QueueInterface::PriorityConfig active1_priorityConfigs[2] = {
      {static_cast<FwQueuePriorityType>(0), active1.getMaxMsgSizeForPriority(static_cast<FwQueuePriorityType>(0)), static_cast<FwSizeType>(5)},
      {static_cast<FwQueuePriorityType>(2), active1.getMaxMsgSizeForPriority(static_cast<FwQueuePriorityType>(2)), static_cast<FwSizeType>(20)},
    };
    static const Os::QueueInterface::InstancePriorityConfig instancePriorityConfigs[1] = {
      {static_cast<FwEnumStoreType>(InstanceIds::active1), 2, active1_priorityConfigs},
    };
    Os::Queue::setPriorityConfig(instancePriorityConfigs, 1);
  }
